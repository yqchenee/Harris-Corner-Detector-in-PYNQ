...
proc create_root_design { parentCell } {
  ...
  # Create instance: HCD_0, and set properties
  set HCD_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:HCD:1.0 HCD_0 ]
  ...
  connect_bd_intf_net -intf_net HCD_0_pstrmOutput [get_bd_intf_pins HCD_0/pstrmOutput] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins HCD_0/pstrmInput] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs HCD_0/s_axi_AXILiteS/Reg] -force
